            ...
            <div class="mb-1">
              ...
              >
                <template #table-row="props">
                  ...
                  <span v-if="props.column.label == 'Ventilator'">
                    <img
                  ...
                  <span v-if="props.column.label == 'Kompresor'">
                    <img
                  ...
                  <span v-if="props.column.label == 'Sirkulator'">
                    <img
                  ...
                  <span v-if="props.column.label == 'Security'">
                    <img
            ...
            <div class="mb-1">
              ...
              >
                <template #table-row="props">
                  ...
                  <span v-if="props.column.label == 'Dokumen'">
                    <img
...
export default {
  ...
  methods: {
    ...
    async fetchData() {
      ...
      const [err, resp] = await jadwalService.showCodeBlueHarian(query);
      if (err) {
        this.toastError({
          title: "Gagal",
    ...
    async fetchDataCodeRed() {
      ...
      let query = queryString.stringify(this.filter);
      const [err, resp] = await jadwalService.showCodeRedHarian(query);
      if (err) {
        this.toastError({
          title: "Gagal",
          msg: err.response?.data?.errors,
